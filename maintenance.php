...
$problem= $_POST['problem'];
        ...
        $sql = "INSERT INTO maintenance (name, email,address,problem) VALUES ('$name', '$email','$address','$problem')";
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group mt-3">
                <textarea class="form-control" name="problem" rows="8" placeholder="Problem" required ></textarea>
              </div>
              <div class="my-3">
