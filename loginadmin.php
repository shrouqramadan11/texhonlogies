...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            header("Location: homeadmin.php?id={$row['id']}"); // Assuming 'id' is the column name for user ID
        }
    } else {
  ...
  <script src="assets/js/main.js"></script>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" style="margin-left:250px" >
            ...
            <form action="" method="post" role="form" class="php-email-form" >
              ...
              <div class="text-center"><a href="login.php" style="width:270px; margin-left:-450px; margin-bottom:-100px; margin-right:700px"> Login as a user</a></div>
            </form>
